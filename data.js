...
window.PORTFOLIO_DATA = {
  ...
  stats: [
    { num: "5+",     label: { en: "Years writing code",            es: "Años programando",                  ca: "Anys programant" } },
    { num: "20+",    label: { en: "Personal & academic projects",  es: "Proyectos personales y académicos", ca: "Projectes personals i acadèmics" } },
    { num: "8",      label: { en: "Languages & frameworks",        es: "Lenguajes y frameworks",            ca: "Llenguatges i frameworks" } },
    { num: "Az‑900", label: { en: "Azure certified",               es: "Certificado Azure",                 ca: "Certificat Azure" } }
  ],

  skillsMarquee: [
    "TypeScript","React","Node.js","C#",".NET","C++","Python","Azure",
    "Docker","Kubernetes","PostgreSQL","Redis","GraphQL","Tailwind",
    "Vite","Next.js","Terraform","Git"
  ],

  skillCategories: [
    { label: "Languages",     items: ["TypeScript","JavaScript","C#","C++","Python","SQL"] },
    { label: "Frontend",      items: ["React","Next.js","Vite","Tailwind","Framer Motion"] },
    { label: "Backend",       items: [".NET","Node.js","Express","PostgreSQL","Redis"] },
    { label: "Cloud / DevOps",items: ["Azure","Docker","Kubernetes","GitHub Actions","Terraform"] }
  ],

  projects: [
    {
      num: "01", title: "OneMore",
      desc: {
      ...
      stack: ["React","TypeScript",".NET","Azure","PostgreSQL"],
      visual: "var-1", year: "2025"
    },
    {
      num: "02", title: "Cloud Pipelines",
      desc: {
      ...
      stack: ["Terraform","Azure","GitHub Actions","Bash"],
      visual: "var-2", year: "2024"
    },
    {
      num: "03", title: "Engine Lab",
      desc: {
      ...
      stack: ["C++","Vulkan","CMake","GLM"],
      visual: "var-3", year: "2024"
    },
    {
      num: "04", title: "Realtime Chat",
      desc: {
      ...
      stack: ["C#","SignalR","React","Redis"],
      visual: "var-4", year: "2023"
    }
  ],

  experience: [
    {
      from: { month: 6, year: 2025 }, to: null,
      role: { en: "Software Engineering Intern", es: "Prácticas de Ingeniería de Software", ca: "Pràctiques d'Enginyeria de Programari" },
      ...
      tags: ["Azure",".NET","React","Terraform"]
    },
    {
      from: { month: 9, year: 2024 }, to: { month: 5, year: 2025 },
      role: { en: "Full-stack Developer (Freelance)", es: "Desarrollador Full-stack (Freelance)", ca: "Desenvolupador Full-stack (Freelance)" },
      company: "Independent",
      desc: {
      ...
      tags: ["TypeScript","Next.js","Node.js","Azure"]
    },
    {
      from: { month: 2, year: 2024 }, to: { month: 8, year: 2024 },
      role: { en: "Teaching Assistant — Programming I", es: "Ayudante de Docencia — Programación I", ca: "Ajudant de Docència — Programació I" },
      company: "University",
      desc: {
      ...
      tags: ["C++","Mentoring","Curriculum design"]
    }
  ],
  ...
  education: [
    {
      ...
      degree: { en: "Specialization in Software Engineering", es: "Especialización en Ingeniería de Software", ca: "Especialització en Enginyeria de Programari" },
      from: 2022, to: 2026, ongoing: true
    },
    {
      school: "High School — Science Track",
      degree: { en: "Diploma with distinction", es: "Diploma con distinción", ca: "Diploma amb distinció" },
      from: 2020, to: 2022, ongoing: false
    }
  ],
  ...
  awards: [
    ...
    { year: 2024, title: "Hackathon Finalist — DevPost Build",               org: "DevPost" },
    { year: 2023, title: "Dean's List",                                      org: "University" }
  ]
};
